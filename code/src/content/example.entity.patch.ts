import { getTemplateFactoryPath, IPath, type QNPatch } from 'quickentity-script'
import type { TChunk, TOption } from '../types'

export const TARGET: IPath = { ...getTemplateFactoryPath('[assembly:/_pro/design/gamecore/setpiecehelpers.template?/setpiecehelpers_activator_singlepress.entitytemplate]') }
